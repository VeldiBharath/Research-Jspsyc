...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '.jspsych-content-wrapper { min-height: 400px; width: 70%; display: flex; align-items: top; }';
    html += ".jspsych-survey-multi-choice-question { margin-top: 1em; margin-bottom: 1em; padding: 1em; background-color: lightblue; text-align: center; }"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center;}"+
      ".jspsych-survey-multi-choice-option { line-height: 1; }"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}"+
      "label.jspsych-survey-multi-choice-text input[type='radio'] {margin-right: 1em;}"+
      "p.jspsych-survey-multi-choice-text { margin-top: 0; }";
    html += '</style>';
