...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      statement: {
        ...
        default: "None",
        description: 'Statement of the stimulus.'
      },
      case: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Case',
        default: "None",
        description: 'Case number of the stimulus'
      }
    }
  }
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '">';
    // Add a div to display the current value of the slider
    html += '<div id="jspsych-html-slider-response-value-box" style="text-align: center; font-size: 100%; margin-bottom: 50px; border: 1px solid #ccc; padding: 10px; display: inline-block;">';
    html += 'Current Slider Value: <span id="jspsych-html-slider-response-value" style="color: blue;">&nbsp;</span>';
    html += '</div>';
  ...
  // Event listener for slider movement
    document.getElementById('jspsych-html-slider-response-response').addEventListener('input', function() {
        var value = this.value;
        update_slider_value(value);
        display_element.querySelector('#jspsych-html-slider-response-next').disabled = false; // Enable button after slider movement
    });
